        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={itemVariants} className="text-center mb-10">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{t("projects1.title")}</h1>
                  ...
                  <div className="relative flex space-x-24 min-w-max px-10">
                    {sortedProjects.map((project, index) => {
                      ...
                      return (
                        <motion.div
                          key={project.id}
                          className={`relative ${isTop ? 'mt-10' : 'mt-28'} flex flex-col items-center`}
                    ...
                    >
                      <Card className="h-full overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <CardHeader>
                          ...
                          <CardDescription className="line-clamp-2 description-font">{project.description}</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <div className="flex flex-wrap gap-2">
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button size="sm" asChild>
                                  <a href={project.demoUrl} target="_blank" rel="noopener noreferrer">
                                    <FiExternalLink className="mr-2" /> {t('projects1.demo')}
                                  </a>
                                </Button>
                              </TooltipTrigger>
                              <TooltipContent>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button size="sm" variant="outline" asChild>
                                  <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                                    <FiGithub className="mr-2" /> {t('projects1.code')}
                                  </a>
                                </Button>
                              </TooltipTrigger>
                              <TooltipContent>
            ...
            {filteredProjects.length === 0 && (
              ...
              >
                <p className="text-lg text-muted-foreground">{t('projects1.noProjects')}</p>
                <Button 
                  variant="outline" 
                  className="mt-4"
                  onClick={() => setSelectedTag(null)}
