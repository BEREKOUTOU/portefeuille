...
function Typewriter({ words = ['Developer', 'Designer', 'Creator'], delay = 150, pauseFor = 2000 }) {
  ...
  return (
    <span className="inline-block min-w-[120px] text-primary">{currentText}<span className="animate-blink">|</span></span>
  );
}
      ...
      <section className="relative min-h-screen pt-20 flex items-center">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              className="text-xl md:text-2xl text-muted-foreground description-font"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.6 }}
            >
              {t('typewriter_intro')} <Typewriter words={[t('typewriter_word1'), t('typewriter_word2'), t('typewriter_word3'), t('typewriter_word4')]} />
            </motion.div>
          ...
          <motion.div 
            className="relative bottom-10 flex justify-center top-20 description-font"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ 
              duration: 0.5, 
      ...
      <section id="about-section" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="max-w-3xl mx-auto text-center space-y-8"
          >
            <h2 className="text-3xl md:text-4xl font-bold">{t('about_me_title')}</h2>
